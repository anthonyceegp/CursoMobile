package aula5// Uma academia deseja fazer um senso entre seus clientes para descobrir o mais alto, o mais baixo, a mais gordo e o mais magro,
...
fun main () {
    ...
    do {
        ...
        val codigoInserido = readLine()!!.toInt()
        if (codigoInserido == 0) {
            break
        }
        print("Insira o peso: ")
        val pesoInserido = readLine()!!.toDouble()
        ...
        val alturaInserida = readLine()!!.toDouble()
